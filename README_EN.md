...
| t16 | Frequency Domain | Bode, Nyquist, Nichols, gain/phase margin | Stability analysis in frequency domain |
...
>> run_all_tutorials       % Run all 21 lessons; figures saved to docs/images/
```
...
After all 21 lessons, you will be able to:
